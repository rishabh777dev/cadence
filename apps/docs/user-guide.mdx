...
<Tabs>
  ...
  <Tab title="Cloud (your own key)">
    Often faster and more accurate, but needs internet and a key. Supported transcription providers: **OpenAI**, **Groq**, **Deepgram**, and **ElevenLabs**.
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues & Support" icon="github" href="https://github.com/rishabh777dev/cadence/issues">
    Ask questions, request features, and report bugs.
  </Card>
</CardGroup>
