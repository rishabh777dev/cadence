...
LRESULT CALLBACK LowLevelKeyboardProc(int nCode, WPARAM wParam, LPARAM lParam) {
    if (nCode == HC_ACTION) {
        ...
        /* Ignore synthetic/injected keyboard events from SendInput / keybd_event (e.g. fast-paste copy/paste)
           so that programmatic copy operations do not falsely release or trigger the push-to-talk hotkey. */
